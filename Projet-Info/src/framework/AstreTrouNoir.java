	...
	public class AstreTrouNoir  extends Astre { 	//Astre de forme sphérique défini par son rayon
		
		//Circle limites;
		double rayon;								//Rayon de l'astre

		public AstreTrouNoir(int ax, int ay, float adx, float ady,	String[] NomImage, Rectangle aframe, String nom, int nbIm, int masse, double rayon) {
