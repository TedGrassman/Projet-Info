...
public class Trajectoire {
	...
	public void draw(long t, Graphics g) { // RMQ : utiliser un buffer pour
											// l'appel sinon c'est pas fluide
		if (listePoints.size() > delai) { // vérifie que la liste est plus
											// longue que le délai souhaité
			final Color preced = g.getColor(); // stocke la couleur actuelle du
												// Graphics
